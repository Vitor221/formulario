        ...
        <div class="row">
            <div class="col-6 bg-light">
                ...
                <form @reset.prevent="resetar()">
                    ...
                    <div class="mb-3 row">
                        <label class="col-3 col-form-label">Placa do Veículo de Mercosul:</label>
                        <div class="col">
                    ...
                    <div class="mb-3 row">
                        <label class="col-3 col-form-label">Número do RG:</label>
                        <div class="col">
            ...
            <div class="col-6 text-white bg-secondary" :style="'background-color:'+form.cor+'!important'">
                ...
                <div class="mb-3 row">
                    <span>Placa do Veículo: {{ form.placaVeiculo }}</span>
                </div>
                <div class="mb-3 row">
                    <span>Placa do Veículo de Mercosul: {{ form.placaVeiculoMercosul }}</span>
                </div>
                <div class="mb-3 row">
                    <span>Número do RG: {{ form.rg }}</span>
                </div>
                <div class="mb-3 row">
