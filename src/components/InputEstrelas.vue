<template>
  <div>
    <i v-for="estrela in estrelas" :key="estrela.id" :class="estrela.estilo" @click.prevent="marcarAvaliacao(estrela.id)"></i>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    marcarAvaliacao(e) {
      ...
      //enviar o evento personalizado para o componente pai
